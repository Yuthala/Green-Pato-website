		...
		<section className="policy">
			...
			<ol>
				...
				<li className="policy-subheader">Заключительные положения</li>
					<ul>
						<li>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты sales@greenpato.ru.</li>
