...
export default function Onion() {
    ...
    return (
        <main>
            <section className="onion" id="onion">
                ...
                <div className="content">
                        ...
                        <ul className="onion-sorts" itemScope itemType="http://schema.org/Product">
                            {SortShalot}
                        </ul>
