...
import scheme1 from '../../images/garlic/scheme1.webp';
import scheme2 from '../../images/garlic/scheme2.webp';
...
export default function Garlic() {
    ...
    return (
        <main>
            <section className="garlic" id="garlic">
                ...
                <div className="content">
                    ...
                    Различают яровой и озимый чеснок. Отличительной особенностью озимого чеснока является наличие цветоноса - так называемой "стрелки". После высыхания цветонос приобретает вид сухого стержня в центре головки. У ярового чеснока нет цветоноса, и количество зубков в среднем больше и они мельче.<br/> Во второй половине вегетационного периода на вершине цветоноса у озимого чеснока появляется семенная коробочка, наполненная маленькими луковками - воздушные луковицы чеснока (бульбочки). Воздушные луковицы представляют собой вегетативные органы размножения чеснока, а не семена. Яровой чеснок размножается прикорневыми луковками.
                    </p>
                    ...
                    Почва должна иметь нейтральную или слабощелочную реакцию. Кислотность почвы определяют агрохимическим тестом (продается в огородных магазинах - тест на кислотность почвы). В кислую почву перед посадкой вносят доломитовую муку 0,3-0,5 кг/кв.м в зависимости от кислотности почвы. <br/>
                    Чеснок не переносит застоя воды у корней, поэтому почва для посадки должна иметь хороший дренаж. Повышенная влажность вызывает развитие грибковых заболеваний у чеснока.</p>
                    <h3>Посадка</h3>
                    <p>Озимый чеснок сажают осенью, так как ему для правильного развития требуется пройти фазу яровизации - длительного нахождения при температуре от +1℃ до +7℃. Для определения точных сроков посадки озимого чеснока нужно ориентироваться на погодные условия вашего региона. Посадку производят примерно за месяц до устойчивых заморозков, т.е., когда среднесуточная температура опускается до +10℃ и держится так в течение 10 дней. В средней полосе России это вторая половина октября. В северных регионах вторая половина сентября-начало октября. В южных - самый конец октября-середина ноября.<br/>
                    Яровой чеснок сажают весной, в марте-апреле после схода снега.</p>
                    ...
                    <div className="garlic-assort" itemScope itemType="http://schema.org/Product">
                        {Type}
                    </div>
